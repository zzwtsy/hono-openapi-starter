...
const router = createRouter()
  ...
  .openapi(routes.getMyAuthorizationRoute, handlers.getMyAuthorizationHandler)
  ...
  .openapi(routes.resetUserPasswordRoute, handlers.resetUserPasswordHandler)
  .openapi(routes.disableUserRoute, handlers.disableUserHandler)
  .openapi(routes.enableUserRoute, handlers.enableUserHandler)
  .openapi(routes.transferUserOrganizationRoute, handlers.transferUserOrganizationHandler)
  ...
  .openapi(routes.updateRolePermissionsRoute, handlers.updateRolePermissionsHandler)
  .openapi(routes.deleteRolePermissionRoute, handlers.deleteRolePermissionHandler)
  .openapi(routes.listRoleUsersRoute, handlers.listRoleUsersHandler)
