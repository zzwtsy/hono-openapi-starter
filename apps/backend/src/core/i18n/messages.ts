...
const zh: Record<ErrorCode, string> = {
  ...
  USER_CANNOT_MODIFY_OWN_AUTH: "不能修改自己的授权",
  ...
  ROLE_REQUIRES_SYSTEM_ROOT: "只有系统根管理员可以维护全局角色",
  PERMISSION_NOT_FOUND: "权限不存在: {permissionCode}",
  PERMISSION_CODE_INVALID: "权限 code 无效",
  ORG_NOT_FOUND: "组织不存在",
  ORG_CYCLE: "组织会形成环",
  ORG_HAS_CHILDREN: "组织有子组织",
  ORG_HAS_USERS: "组织下仍有用户",
  ORG_SAME_AS_CURRENT: "目标组织与当前相同",
  ORG_ROOT_IMMUTABLE: "系统根组织的拓扑不可修改",
  ASSIGNMENT_EXCEEDS_ACTOR_PERMISSION: "不能授予超出自身权限或有效期的权限",
