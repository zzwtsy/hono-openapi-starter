...
const permissionCacheStorage = new AsyncLocalStorage<Map<string, boolean | UserPermissionsResult>>();
...
export function getPermissionCache(): Map<string, boolean | UserPermissionsResult> | undefined {
