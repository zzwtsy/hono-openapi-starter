...
const navItems: NavItem[] = [
  ...
  { to: "/iam/roles", title: "角色", icon: ShieldCheck, permission: "roles.read", match: p => p.startsWith("/iam/roles") },
  { to: "/iam/organizations", title: "组织", icon: Building2, permission: "organizations.read", match: p => p.startsWith("/iam/organizations") },
