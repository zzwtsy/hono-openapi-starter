...
export default {
  ...
  'IAM.getMyAuthorization': ['GET', '/api/v1/me/authorization'],
  ...
  'IAM.assignUserPermission': ['POST', '/api/v1/users/{userId}/permissions/{permissionCode}'],
  'IAM.deleteUserPermission': ['DELETE', '/api/v1/users/{userId}/permissions/{permissionCode}'],
