...
| statesHook     | object                      | State management hook, optional, [For Detail](https://alova.js.org/tutorial/getting-started/basic/combine-framework.md)                       |
...
📄 [Token Authentication Documentation](https://alova.js.org/tutorial/client/strategy/token-authentication.md)
